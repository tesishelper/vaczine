...
public class Ayuda3SIR implements Screen{
    ...
    public Ayuda3SIR(VaczineGame game) {
        this.game = game;
    ...
    public void show() {
     ...
     //   if(game.getMusicaOn()==1){ m.playMusic();}//musica de ambiente
      ...
      //  img = new Texture("fondo.jpg");//imagen
        img2 = new Texture("pantalla_Ayuda3SIR_"+game.getIdioma()+".png");//imagen
        //	img.set
        ...
        b_vermas = new TextButton(game.getTx().getLimitacionesDelModelo(), estilo);
        ...
        m.addBoton(b_vermenos,0.4f,1f,200,60,410,10);
        m.addBoton(b_vermas,0.4f,1f,200,60,612,10);
    ...
    public void render(float delta) {
       ...
       // batch.draw(img, 0, 0, ancho,alto);
        ...
        if(verCaja==true){
            ...
            fuenteAmarilla.getData().setScale(2,2);
            batch.begin();
            if (stage.getKeyboardFocus() == tf_dias){m.addTexto(batch,fuenteAmarilla,tf_dias.getText(), 420,410);}
